...
int main( int argc, char ** argv )
{
    ...
    for( i = 0 ; i < 0 && b == 1 ; ++i ) b = b & test_gf4096_inverse();
    for( i = 0 ; i < 0 && b == 1 ; ++i ) b = b & test_gf4096x_add();
    for( i = 0 ; i < 0 && b == 1 ; ++i ) b = b & test_gf4096x_multiply();
    for( i = 0 ; i < 1000 && b == 1 ; ++i ) b = b & test_gf4096x_divide();
    for( i = 0 ; i < 0 && b == 1 ; ++i ) b = b & test_gf4096x_xgcd();
